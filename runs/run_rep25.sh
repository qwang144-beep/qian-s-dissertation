#!/bin/bash
#SBATCH --job-name=rep25_300
#SBATCH --partition=gpu
#SBATCH --qos=gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=12:00:00
#SBATCH --output=rep25_300_%j.out
#SBATCH --error=rep25_300_%j.err
...
$PY src/generate_metrical.py \
  ...
  --out-dir metrical_300_rep25 \
  --model Qwen/Qwen2.5-7B-Instruct \
  --n-candidates 8 \
  --k-context 3 \
  --temperature 0.9 \
  --w-count 3.0 --w-rhyme 1.0 --w-vocab 0.7 --w-rep 2.5 \
  --dump-candidates cand_dump_rep25.jsonl
