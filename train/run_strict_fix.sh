#!/bin/bash
#SBATCH --job-name=strictfix300
#SBATCH --partition=gpu
#SBATCH --qos=gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=12:00:00
#SBATCH --output=strictfix300_%j.out
#SBATCH --error=strictfix300_%j.err
